...
<head>
  ...
  <!-- <link rel="stylesheet" href="https://bootswatch.com/4/_assets/css/custom.min.css"> -->
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo ROOT_URL; ?>public?page=products">Prodotti</a>
            </li>
            <li class="nav-item">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Area Riservata</a>
